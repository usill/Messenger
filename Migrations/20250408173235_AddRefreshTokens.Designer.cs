...
namespace TestSignalR.Migrations
{
    ...
    [Migration("20250408173235_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestSignalR.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestSignalR.Models.Contact", b =>
                {
                    b.HasOne("TestSignalR.Models.User", "Owner")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("TestSignalR.Models.RefreshToken", b =>
                {
                    b.HasOne("TestSignalR.Models.User", "User")
                        .WithOne("Token")
                        .HasForeignKey("TestSignalR.Models.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
